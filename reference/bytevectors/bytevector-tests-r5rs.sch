...
(define (string-bytevector-tests)
  ...
  ; Given a list of scalar values, returns the corresponding string.
  ; This eliminates the R6RS string syntax of bytevector-tests.sch.

  (define (test-string scalar-values)
    (list->string (map integer->char scalar-values)))
  ...
  (test (bytevector=? (string->utf8
                       ;"k\x007f;\x0080;\x07ff;\x0800;\xffff;"
                       (test-string '(107 127 128 2047 2048 65535)))
                      '#(#x6b
                            #x7f
                            #b11000010 #b10000000
                            #b11011111 #b10111111
  ...
  (test (bytevector=? (string->utf8
                       ;"\x010000;\x10ffff;"
                       (test-string '(65536 1114111)))
                      '#(#b11110000 #b10010000 #b10000000 #b10000000
                            #b11110100 #b10001111 #b10111111 #b10111111))
        => #t)

  (test (string=? (utf8->string '#(#x61                             ; a
                                      #xc0 #x62                        ; ?b
                                      #xc1 #x63                        ; ?c
                                      #xc2 #x64                        ; ?d
                                      #x80 #x65                        ; ?e
                  ...
                  (test-string '(97 65533 98 65533 99 65533 100 65533
                                 101 65533 65533 102 65533 103)))
        => #t)

  (test (string=? (utf8->string '#(#xe0 #x80 #x80 #x68              ; ???h
                                      #xe0 #xc0 #x80 #x69              ; ???i
                                      #xf0 #x6a                        ; ?j
                                     ))
                  ;"\xfffd;\xfffd;\xfffd;h\xfffd;\xfffd;\xfffd;i\xfffd;j"
                  (test-string '(65533 65533 65533 104 65533 65533 65533
                                 105 65533 106)))
        => #t)
  ...
  (test (string=? (utf8->string '#(#x61                             ; a
                  ...
                  (test-string '(97 65533 65533 65533 65533 98 65536 99)))
        => #t)
  ...
  (test (string=? (utf8->string '#(#x61                             ; a
                  ...
                  (test-string '(97 262143 100 65533 101 65533 102)))
        => #t)
  ...
  (test (string=? (utf8->string '#(#x61                             ; a
                  ...
                  (test-string '(97 1114111 98 65533 65533 65533 65533 99)))
        => #t)
  ...
  (test (string=? (utf8->string '#(#x61                             ; a
                  ...
                  (test-string '(97 65533 65533 65533 65533 100)))
        => #t)

  ; ignores BOM signature

  (test (string=? (utf8->string '#(#xef #xbb #xbf #x61 #x62 #x63 #x64))
                  "abcd")
        => #t)
  ...
  (test (bytevector=? (string->utf16
                       ...
                       (test-string '(65536 1039546 1114111)))
                      '#(#xd8 #x00 #xdc #x00
                            #xdb #xb7 #xdc #xba
                            #xdb #xff #xdf #xff))
        => #t)
  ...
  (test (bytevector=? (string->utf16
                       ...
                       (test-string '(97 98 65536 1039546 1114111 99 100)))
                      (string->utf16
                       ;"ab\x010000;\xfdcba;\x10ffff;cd"
                       (test-string '(97 98 65536 1039546 1114111 99 100))
                       'big))
  ...
  (test (string=? ;"a\xfffd;b\xfffd;c\xfffd;d\xfffd;e"
                  (test-string '(97 65533 98 65533 99 65533 100 65533 101))
                  (utf32->string
                   '#(#x00 #x00 #x00 #x61
                         #x00 #x00 #xd9 #x00
                         #x00 #x00 #x00 #x62
  ...
  (test (string=? ;"a\xfffd;b\xfffd;c\xfffd;d\xfffd;e"
                  (test-string '(97 65533 98 65533 99 65533 100 65533 101))
                  (utf32->string
                   '#(#x00 #x00 #xfe #xff   ; big-endian BOM
                         #x00 #x00 #x00 #x61
                         #x00 #x00 #xd9 #x00
                         #x00 #x00 #x00 #x62
                         #x00 #x00 #xdd #xab
  ...
  (test (string=? ;"\xfeff;a\xfffd;b\xfffd;c\xfffd;d\xfffd;e"
                  (test-string '(65279 97 65533 98 65533 99 65533 100
                                 65533 101))
                  (utf32->string
                   '#(#x00 #x00 #xfe #xff   ; big-endian BOM
                         #x00 #x00 #x00 #x61
  ...
  (test (string=? ;"a\xfffd;b\xfffd;c\xfffd;d\xfffd;e"
                  (test-string '(97 65533 98 65533 99 65533 100 65533 101))
                  (utf32->string
                   '#(#xff #xfe #x00 #x00   ; little-endian BOM
                         #x61 #x00 #x00 #x00
                         #x00 #xd9 #x00 #x00
                         #x62 #x00 #x00 #x00
                         #xab #xdd #x00 #x00
