...
\item If \vari{obj} and \varii{obj} have different record types (i.e.\
  ...
  returns false.
\item If \vari{obj} and \varii{obj} are both immutable records, then
...
Moreover, if \vari{obj} and \varii{obj} are both immutable records,
and {\cf (eqv? \vari{obj} \varii{obj})} returns \schtrue, then
...
specified bx \var{rtd}, and which can be obtained
