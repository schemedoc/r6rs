...
identifiers are all exported by the \library{r6rs records explicit}
...
As with the explicit-naming layer, the {\cf fields}, {\cf mutable},
{\cf immutable}, {\cf parent}, {\cf protocol}, {\cf sealed}, {\cf
  opaque}, and {\cf nongenerative} are exported with level $0$.
