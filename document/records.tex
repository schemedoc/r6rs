...
\begin{note}
  Use of the {\cf parent-rtd} clause may force an implementation to
...
The following examples the procedural layer (see
section~\ref{recordsproceduralsection}) to demonstrate some aspects of
the semantics of {\cf define-record-type}.
