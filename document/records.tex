...
\item the \library{r6rs records procedural} library,
  ...
  instances,
\item the \library{r6rs records syntactic} library,
...
The syntactic layer is provided by the \deflibrary{r6rs records
  syntactic} library.
...
identifiers are all exported by the \library{r6rs records syntactic}
