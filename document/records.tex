...
If \hyper{parent rtd} evaluates to \schfalse, the record type being
defined is a base record type.  In this case, if \hyper{parent cd}
evaluates to a value, that value must be \schfalse.  If \hyper{parent
  cd} evaluates to \schfalse{}, the protocol of the value of
\hyper{parent rtd} must be a default protocol (see below).
