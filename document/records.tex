...
protocol expression in a {\cf define-record-type} formj.

FIXME

called by {\cf record-constructor}
...
the number of arguments it expects, call the procedure \var{p} it
...
\var{parent-constructor-descriptor} or \var{protocol} is \schfalse,
\var{protocol} must also be \schfalse, and a default constructor
