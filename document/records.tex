...
The \var{parent} argument shall be either \schfalse{} or an rtd. If it is an
...
The \var{uid} argument shall be either \schfalse{} or a symbol.
...
The \var{sealed?} flag shall be a boolean. If true, the returned record type
is sealed, i.e., it cannot be extended.

The \var{opaque?} flag shall be a boolean. If true, the record type
is opaque.
