...
as immutable raises an exception with condition type {\cf\&assertion}.
...
implemented as a opaque record type.  Consequently, {\cf record?},
...
Returns a list of symbols naming the fields of the type represented by \var{rtd}
