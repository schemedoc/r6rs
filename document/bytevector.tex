...
\domain{\var{K} must be a valid index of \var{bytevector}; so must
  $\var{k} + 1$. For {\cf bytevector-u16-set!} and {\cf
    bytevector-\linebreak[0]u16-native-\linebreak[0]set!}, \var{n} must be an exact integer object in
...
\domain{$\var{K}, \ldots, \var{k}+ 3$ must be valid indices of
  ...
  For {\cf bytevector-u32-set!} and {\cf
    bytevector-\linebreak[0]u32-\linebreak[0]native-\linebreak[0]set!}, \var{n} must be an exact integer
  object in
...
\domain{$\var{K}, \ldots, \var{k}+ 7$ must be valid indices of
  ...
  For {\cf bytevector-u64-set!} and {\cf
    bytevector-\linebreak[0]u64-\linebreak[0]native-\linebreak[0]set!}, \var{n} must be an exact integer
  object in
