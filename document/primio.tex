...
Some of the procedures described here accept a file name \var{filename} as an
argument. Valid values for such a file name include strings naming a file using
...
systems do not really use strings for representing file names, but rather byte
