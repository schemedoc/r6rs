...
\pproto{\singlequote\hyper{S-expression}}{\exprtype}
\pproto{\hyper{constant}}{\exprtype}}

{\cf (quote \hyper{S-expression})} evaluates to the datum denoted by
\hyper{S-expression}.\mainschindex{'} (See
...
section~\ref{valuessection}).  With the exception of {\cf values}
