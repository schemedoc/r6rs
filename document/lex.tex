...
(library section~\ref{lib:portsiosection})
...
the input which follows is written purely with the lexical syntax described by
...
which follows is written purely with the lexical syntax described in this
...
library section~\ref{lib:bytevectorschapter}), are written using the notation
