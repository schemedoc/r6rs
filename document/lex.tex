...
\begin{center}
  \begin{tabular}{ll}
    ...
    {\tt "\backwhack{}x41"} & \exception{\&lexical}\\
    {\tt "\backwhack{}x;"} & \exception{\&lexical}\\
    {\tt "\backwhack{}x41bx;"} & \exception{\&lexical}\\
    {\tt "\backwhack{}x00000041;"} & ; ``A'', Unicode sequence 65\\
    {\tt "\backwhack{}x0010FFFF;"} &  ; Unicode sequence \#x10FFFF\\
    {\tt "\backwhack{}x00110000;"}&  \exception{\&lexical} (out of range)\\
    {\tt "\backwhack{}x000000001;"}& \exception{\&lexical} (too many digits)\\
    {\tt "\backwhack{}xD800;"}& \exception{\&lexical} (in excluded range)
  \end{tabular}
\end{center}
