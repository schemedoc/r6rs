...
Scheme source code, and of the line endings in \meta{line ending}
...
which follows is written with the lexical and read syntax described in this
...
In addition, \ide{+}, \ide{-}, and \ide{...} are identifiers. 
...
\item{\tt \backwhack{}x\atleastone{\hyper{digit 16}};} : (note the
  terminating semi-colon) the sequence of \hyper{digit 16}s forms a
