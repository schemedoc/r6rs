...
FIXME: Matching pairs of parentheses that occur in the rules of
...
\pproto{\comma\hyper{S-expression}}{}
\pproto{\comma\atsign\hyper{S-expression}}{}
}
...
\mainschindex{,}\comma\hyper{S-expression} is an abbreviation
for {\cf (unquote \hyper{S-expression})}.
\mainschindex{,@}\comma\atsign\hyper{S-expression} is an abbreviation
