...
Scheme source code consists of syntactic datums and (non-significant) comments
Syntactic datums in Scheme source code are called
...
{\cf\#\backwhack{}a}          \> \textrm{lower case letter a}\\
{\cf\#\backwhack{}A}         \> \textrm{upper case letter A}\\
{\cf\#\backwhack{}(}          \> \textrm{left parenthesis}\\
{\cf\#\backwhack{}}           \> \textrm{space character}\\
{\cf\#\backwhack{}nul}        \> \textrm{U+0000}\\
{\cf\#\backwhack{}alarm}      \> \textrm{U+0007}\\
{\cf\#\backwhack{}backspace}  \> \textrm{U+0008}\\
{\cf\#\backwhack{}tab}        \> \textrm{U+0009}\\
{\cf\#\backwhack{}linefeed}   \> \textrm{U+000A}\\
{\cf\#\backwhack{}vtab}       \> \textrm{U+000B}\\
{\cf\#\backwhack{}page}       \> \textrm{U+000C}\\
{\cf\#\backwhack{}return}     \> \textrm{U+000D}\\
{\cf\#\backwhack{}esc}        \> \textrm{U+001B}\\
{\cf\#\backwhack{}space}      \> \textrm{U+0020}\\
 \> preferred way to write a space\\
{\cf\#\backwhack{}delete}     \> \textrm{U+007F}\\[1ex]
{\cf\#\backwhack{}xFF}        \> \textrm{U+00FF}\\
{\cf\#\backwhack{}x03BB}      \> \textrm{U+03BB}\\
{\cf\#\backwhack{}x00006587}  \> \textrm{U+6587}\\
{\cf\#\backwhack{}\(\lambda\)} \> \textrm{U+03BB}\\[1ex]
{\cf\#\backwhack{}x0001z}     \> \exception{\&lexical}\\
{\cf\#\backwhack{}\(\lambda\)x}         \> \exception{\&lexical}\\
{\cf\#\backwhack{}alarmx}     \> \exception{\&lexical}\\
{\cf\#\backwhack{}alarm x}   \> \textrm{U+0007}\\
 \> followed by {\cf{}x}\\
{\cf\#\backwhack{}Alarm}      \> \exception{\&lexical}\\
{\cf\#\backwhack{}alert}      \> \exception{\&lexical}\\
{\cf\#\backwhack{}xA}         \> \textrm{U+000A}\\
{\cf\#\backwhack{}xFF}        \> \textrm{U+00FF}\\
{\cf\#\backwhack{}xff}        \> \textrm{U+00FF}\\
{\cf\#\backwhack{}x ff}       \> \textrm{U+0078}\\
 \> followed by another datum, {\cf{}ff}\\
{\cf\#\backwhack{}x(ff)}      \> \textrm{U+0078}\\
 \> followed by another datum,\\
 \> a parenthesized {\cf{}ff}\\
{\cf\#\backwhack{}(x)}        \> \exception{\&lexical}\\
{\cf\#\backwhack{}(x}         \> \exception{\&lexical}\\
{\cf\#\backwhack{}((x)}       \> \textrm{U+0028}\\
 \> followed by another datum,\\
 \> parenthesized {\cf{}x}\\
{\cf\#\backwhack{}x00110000}  \> \exception{\&lexical}\\
 \> out of range\\
{\cf\#\backwhack{}x000000001} \> \textrm{U+0001}  \\
{\cf\#\backwhack{}xD800}      \> \exception{\&lexical}\\
 \> in excluded range
\end{tabbing}
...
\begin{tabbing}
{\cf "\backwhack{}x0000000000;"} \=\kill
{\cf "abc"} \>  \textrm{U+0061, U+0062, U+0063}\\
{\cf "\backwhack{}x41;bc"} \>  {\cf "Abc"} ; \textrm{U+0041, U+0062, U+0063}\\
{\cf "\backwhack{}x41; bc"} \> {\cf "A bc"}\\
 \>U+0041, U+0020, U+0062, U+0063\\
{\cf "\backwhack{}x41bc;"} \>  \textrm{U+41BC}\\
{\cf "\backwhack{}x41"} \> \exception{\&lexical}\\
{\cf "\backwhack{}x;"} \> \exception{\&lexical}\\
{\cf "\backwhack{}x41bx;"} \> \exception{\&lexical}\\
{\cf "\backwhack{}x00000041;"} \>  {\cf "A"} ; \textrm{U+0041}\\
{\cf "\backwhack{}x0010FFFF;"} \> \textrm{U+10FFFF}\\
{\cf "\backwhack{}x00110000;"} \>  \exception{\&lexical}\\
 \>out of range\\
{\cf "\backwhack{}x000000001;"} \> \textrm{U+0001}\\
{\cf "\backwhack{}xD800;"} \> \exception{\&lexical}\\
 \>in excluded range\\
{\cf "A}\\
{\cf bc"} \> \textrm{U+0041, U+000A, U+0062, U+0063}\\
 \>if no space occurs after the {\cf{}A}
\end{tabbing}
