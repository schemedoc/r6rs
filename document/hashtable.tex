...
compare keys.  The hash function shall accept a key and return a 
...
Applies \var{proc} to the value in \var{hash-table}
...
\var{proc} with three arguments: the association
