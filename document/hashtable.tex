...
Removes all associations from \var{hash-table} and returns \unspecifiedreturn.
...
Returns a vector of all keys in \var{hash-table}.
The order of the vector is unspecified.
\end{entry}

\begin{entry}{%
\proto{hash-table-entries}{ \var{hash-table}}{procedure}}

Returns two values, a vector of the keys in \var{hash-table}, and a
