...
that shall be hash tables, and the \var{key} parameter name for
arguments that shall be hash-table keys.
...
\domain{\var{Hash-function} and \var{comparator} shall be procedures.
\var{Hash-function} will be called by other procedures described in
this chapter with a key as argument, and shall returns a 
non-negative exact integer.
\var{Comparator} will be called by other procedures described in
this chapter with two keys as arguments, and shall return a 
boolean.}
...
\domain{\var{Proc} shall be a procedure that takes a single argument.}
...
\domain{\var{Proc} shall be a procedure that takes three arguments.}
