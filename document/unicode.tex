...
A character is numeric if
it is in category Nd.  A character is whitespace if has the Unicode
...
procedure converts the first cased character of each word to title
...
\begin{note}
  ...
  {\cf string-titlecase}, is specified in Unicode Annex
