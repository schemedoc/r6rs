...
\item Identifiers, number representations, characters, booleans, and
  dot must be explicitly delimited.
...
\item {\cf #} can no longer be used in place of digits in number
  representations.
