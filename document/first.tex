...
\multicolumn{4}{c}{
  R\authorsc{ICHARD} K\authorsc{ELSEY}, \authorsc{ONATHAN} R\authorsc{EES}} \\
\multicolumn{4}{c}{(\textit{Editors, Revised$^5$ Scheme})} \\
\\
H. A\authorsc{BELSON}     &
...
\multicolumn{4}{c}{(\textit{Authors, Revised$^5$ Scheme})} \\[1ex]
