...
\multicolumn{4}{c}{
  R\authorsc{ICHARD} K\authorsc{ELSEY} (\textit{Editor, Revised$^5$ Scheme})} \\
\multicolumn{4}{c}{
  J\authorsc{ONATHAN} R\authorsc{EES} (\textit{Editor, Revised$^{\textit{3--5}}$ Scheme})} \\
\\
H. A\authorsc{BELSON}     &
...
\multicolumn{4}{c}{(\textit{Authors, Revised$^{\textit{0--5}}$ Scheme})} \\[1ex]
