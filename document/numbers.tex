...
Integer number objects are also called \defining{integer objects}.
...
\mainindex{exactness}It useful to distinguish between number objects
...
Numbers objects are either \defining{exact} or \defining{inexact}.  A
...
to designate a subset of its inexact real number objects representing as \defining{flonum}s, and
