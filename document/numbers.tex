...
exact integers. (Library section \ref{lib:fixnumssection} describes a
...
(Library section \ref{lib:flonumssection} describes a library for
computing with fixnums.)  Note that
