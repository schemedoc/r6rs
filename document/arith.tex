...
\domain{\varii{fx} shall be non-negative.}  This procedure returns the
...
\domain{\varii{fx} shall be non-negative.}  This procedure
...
\domain{\varii{Fx} and \variii{fx} shall be non-negative.}  This procedure
returns the fixnum result of the following computation:
%
\begin{scheme}
(let* ((mask (fixnum-not
...
\domain{The second and third arguments shall be non-negative.} This procedure
returns the fixnum result of the following computation:
\begin{scheme}
(let* ((to    \vari{fx})
       (start \varii{fx})
...
\domain{\varii{Fx} shall be non-negative.}  This procedure returns
...
\domain{\varii{ei} and \variii{ei} shall be non-negative, and
  \varii{ei} shall be less than or equal to \variii{ei}.}  This procedure returns
