...
\domain{The second and third arguments shall be non-negative.} The
...
1.}  The {\cf fxcopy-bit} procedure returns the same result returned by {\cf
  fixnum-copy-bit}.
\end{entry}
...
{\cf fltruncate} returns the integral flonum closest to \var{fl} whose
...
\domain{\var{ei} shall be a non-negative exact integer.}
...
\domain{\varii{Ei} shall be a non-negative exact integer.}
...
\domain{\varii{Ei} and \variii{ei} shall be non-negative, and
  \varii{fx} shall be less than or equal to \variii{fx}.}  This
...
\domain{\varii{Fx} and \variii{fx} shall be non-negative,
and \varii{fx} shall be less than or equal to \variii{fx}.}
