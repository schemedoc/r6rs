...
\domain{\varii{Fx} shall be non-negative.}  The {\cf fixnum-bit-set?} procedure returns the
...
\domain{\varii{Fx} shall be non-negative.}  The {\cf fixnum-copy-bit} procedure
...
\domain{\varii{Fx} and \variii{fx} shall be non-negative.}  The {\cf fixnum-bit-field} procedure
returns the fixnum result of the following computation:
%
\begin{scheme}
(let* ((mask (fixnum-not
...
\domain{\varii{Fx} and \variii{fx} shall be non-negative.} The
...
\domain{\varii{Fx} shall be non-negative.}  {\cf
...
\domain{\varii{Fx} shall be non-negative.}  The {\cf fixnum-logical-shift-right} procedure returns
...
\domain{\varii{Fx}, \variii{fx}, and \variv{fx} shall be non-negative.}
...
\domain{\varii{Fx} shall be nonzero.}
...
\domain{\varii{Fx} shall be non-negative and less than {\cf
...
\domain{\varii{Fx} shall be non-negative and less than {\cf
  (fixnum-width)}. \variii{Fx} shall be 0 or
...
\domain{\varii{Fx} and \variii{fx} shall be non-negative and less than
  {\cf (fixnum-width)}.  Moreover, \varii{fx} shall be less than or
...
\domain{\varii{Fx} and \variii{fx} shall be non-negative and less than
  {\cf (fixnum-width)}.  Moreover, or \varii{fx} shall be less than or
...
\domain{The absolute value of the \varii{fx} shall be less than 
{\cf (fixnum-width)}.}  If
%
\begin{scheme}
(exact-floor (* \vari{fx} (expt 2 \varii{fx})))%
...
\domain{\varii{Fx}, \variii{fx}, and \variv{fx} shall be non-negative
  and less than {\cf (fixnum-width)}.  \variv{Fx} shall be less than
...
parameter names for arguments that shall be flonums, and \var{ifl},
...
parameter names for arguments that shall be exact complex numbers, \var{ef},
\vari{ef}, \varii{ef}, and \variii{ef} as parameter names for arguments 
that shall be exact rational numbers, and \var{ei}, \vari{ei}, \varii{ei}, and
\variii{ei} as parameter names that shall be exact integers.
...
\domain{\varii{Ef} shall be nonzero.}
These procedures implement number-theoretic integer division and
return the results of the corresponding mathematical operations
...
\domain{\var{Ei} shall be non-negative.}
...
\domain{\varii{Ei} shall be non-negative.}
...
\domain{\varii{Ei} shall be non-negative, and \variii{ei}
...
\domain{\varii{Ei} and \variii{ei} shall be non-negative, and
  \varii{ei} shall be less than or equal to \variii{ei}.}  This
...
\domain{\varii{Ei} and \variii{ei} shall be non-negative,
and \varii{ei} shall be less than or equal to \variii{ei}.}
...
\domain{\varii{Ei} shall be non-negative.}  {\cf
...
\domain{\varii{Ei}, \variii{ei}, \variv{ei} shall be non-negative, and \variv{ei}
shall be less than the difference between \varii{ei} and \variii{ei}.}
...
\domain{\varii{Ei} and \variii{ei} shall be non-negative, and
  \varii{ei} shall be less than or equal to \variii{ei}.}  The {\cf exact-reverse-bit-field} procedure returns
...
\variii{in} as parameter names for arguments that shall be inexact numbers,
...
\domain{\vari{Ir}
shall be neither infinite nor a NaN, and \varii{ir} shall be nonzero.}
These procedures implement number-theoretic integer division and
return the results of the corresponding mathematical operations
specified in section~\ref{integerdivision}.  
...
real numbers, and \var{ir} is a complex number, such that
%
\begin{displaymath}
...
%
\begin{scheme}
(inexact-make-rectangular \vari{ir} \varii{ir}) \lev \var{ir}
(inexact-make-rectangular \variii{ir} \variv{ir}) \lev \var{ir}
(inexact-real-part \var{ir})              \ev \vari{ir}
(inexact-imag-part \var{ir})              \ev \varii{ir}
(inexact-magnitude \var{ir})              \ev |\variii{ir}|
(inexact-angle \var{ir})                  \ev \var{ir}\(_{\mathrm{angle}}\)%
\end{scheme}
%
...
\begin{scheme}
(inexact-make-rectangular \vari{ir} \varii{ir}) \lev \var{ir}
(inexact-magnitude \var{ir})              \ev +inf.0%
\end{scheme}
\end{entry}
