...
(fxdiv-and-mod \vari{fx} \varii{fx})     \lev \(\vari{fx}~\mathrm{div}~\varii{fx}, \vari{fx}~\mathrm{mod}~\varii{fx}\)\\\>\>; \texttt{two return values}
...
the \varii{fx}th bit of \vari{fx} by the \varii{fx}th bit of \variii{fx}, which is
