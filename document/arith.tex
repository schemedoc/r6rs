...
should be an integer; otherwise, the result may be a NaN, or may
...
exact integers.  This section uses \var{ei}, \vari{ei}, \varii{ei}, etc.,
as parameter names that must be exact integers.

Some procedures allow extracting \defining{bit fields}, i.e., numbers
