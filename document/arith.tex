...
\domain{\varii{Fx} and \variii{fx} must be non-negative and less than
  $w-1$.  Moreover, \varii{fx} must be less than or
...
flonums (one for for {\cf fldiv} {\cf flmod}, {\cf fldiv0} and {\cf
...
If \vari{fl} is negative, the result may be a NaN, or may be
