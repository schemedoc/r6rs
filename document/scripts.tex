...
Implementations must provide an executable program named {\cf scheme-script}
which is capable of executing scripts.  On most Unix-like systems, due to the 
...
The remaining rules specify syntax at the form level.
