...
condition type {\cf\&contract} must be raised.
...
considered a syntax violation.  (The explict exports of a library are
immutable, as are the implicit exports outside of the library;
see section~\ref{importsareimmutablesection}.)
