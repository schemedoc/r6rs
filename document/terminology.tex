...
A \var{list} parameter means that it is the
...
programmer.  An implementation responsibility paragraph does not
...
section~\extref{lib:raise-continuable}{Exceptions}.
