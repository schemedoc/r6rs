...
special syntactic form, and the template gives the syntax of form.  Even
...
\var{bytes}&exact integer in $$\{-128, \ldots, 127\}\\
...
\var{datum}&datum value (see section~\ref{readsyntaxsection})\\
