...
procedure that calls procedure from another library, then the latter
...
contain macro transformers defined by procedures---programmers that
...
More generally, every library can be characterized by expand-time information (minimally,
