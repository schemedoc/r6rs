...
definition, or expression. A few expression types are
...
\begin{scheme}
; this example assumes the base library has been imported
(define x 28)
x   \ev  28%
\end{scheme}
\end{entry}
...
\begin{scheme}%
; these examples assume the base library has been imported
(+ 3 4)                          \ev  7
...
\end{scheme}
It is also possible that the keyword reference appears an
...
\begin{scheme}
(set! \hyper{keyword} \hyper{datum} \dotsfoo . \hyper{datum})%
\end{scheme}
