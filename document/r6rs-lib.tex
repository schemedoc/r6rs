...
This report frequently refers back to the \textit{Revised\hspace{1pt}$^6$ Report
...
at the beginning of the \textit{Revised\hspace{1pt}$^6$ Report on the Algorithmic
  Language Scheme}.
