...
exception-raising constructs provided by the \deflibrary{r6rs
  exceptions} library.  This specification follows
SRFI~34~\cite{srfi34}.
...
Returns the result(s) of invoking \var{thunk}. \var{Handler} shall be a
...
The {\cf make-condition-type} procedure returns a new condition type. \var{Id} shall
...
This creates a condition value. Each \hyper{type-field-binding} shall be of
the form
%
\begin{scheme}
