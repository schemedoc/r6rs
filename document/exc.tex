...
\begin{entry}{%
\pproto{(guard ( \hyper{var} \hyperi{clause} \hyperii{clause2} \dotsfoo)  \hyper{body})}{\exprtype}}
\mainschindex{guard}
...
\begin{entry}{%
\rvproto{\&condition}{condition type}}\index{condition@{\tt\&condition}}
...
\begin{entry}{%
\rvproto{\&message}{condition type}}\index{message@{\tt\&message}}
...
\begin{entry}{%
\rvproto{\&warning}{condition type}}\index{warning@{\tt\&warning}}
...
\begin{entry}{%
\rvproto{\&serious}{condition type}}\index{serious@{\tt\&serious}}
...
\begin{entry}{%
\rvproto{\&error}{condition type}}\index{error@{\tt\&error}}
...
\begin{entry}{%
\rvproto{\&violation}{condition type}}\index{violation@{\tt\&violation}}
...
\begin{entry}{%
\rvproto{\&non-continuable}{condition type}}\index{non-continuable@{\tt\&non-continuable}}
...
\begin{entry}{%
\rvproto{\&implementation-restriction}{condition type}}\index{implementation-restriction@{\tt\&implementation-restriction}}
...
\begin{entry}{%
\rvproto{\&irritants}{condition type}}\index{irritants@{\tt\&irritants}}
...
\begin{entry}{%
\rvproto{\&who}{condition type}}\index{who@{\tt\&who}}
