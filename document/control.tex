...
This chapter describes the \deflibrary{r6rs control} library.
...
evaluates to \unspecifiedreturn.
...
false (see report section~\ref{report:booleanvaluessection}), then the \hyper{expression}s
