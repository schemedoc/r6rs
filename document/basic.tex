...
expressions.
A base-library {\cf define} form creates a variable binding that
is visible only within the scope of the body in which it appears,
e.g., the body of a library, top-level program, or base-library
{\cf lambda} expression (see section~\ref{defines}).
Similarly, a base-library {\cf define-syntax} form creates a keyword
binding that is visible only within the scope of the body in which it
appears (see section~\ref{syntaxdefinitionsection}).
