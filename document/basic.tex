...
library that defines most of the constructs traditionally associated with
Scheme programs.
...
continuations that accept other specified numbers of return values.
If the number of
return values passed to a continuation created by a call to
{\cf call-with-values} is not accepted by the \var{consumer}
