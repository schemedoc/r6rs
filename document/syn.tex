...
except in hexadecimal literals; for example, {\cf \#x1A} and {\cf
...
necessarily by anything else.  Characters must be terminated by a
\meta{delimiter} or by the end of the input.
...
\meta{inta-line whitespace} \: $\langle${\rm any \meta{whitespace}}
