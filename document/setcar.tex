...
(set-car! (g) 3)             \ev  \unspecified\\\>; should raise \exception{\&assertion}
\end{scheme}
...
library described in report sections~\ref{report:listsection}, \ref{report:stringsection},
and \ref{report:controlsection}:
