...
\begin{entry}{%
\irproto{length}{ list \vr{k}}{procedure}}

\domain{\var{list} shall be a plausible list.}

\begin{note}
In other words, an exception shall be raised if \var{list}
...
\domain{All \var{list}s shall be plausible lists.}
\end{entry}
...
\domain{\var{l} shall be a plausible list up to \var{k}.}
\end{entry}

\begin{entry}{%
\irproto{list-ref}{ l \vr{k}}{procedure}}

\domain{\var{l} shall be a plausible list up to and including \var{k}.}
\end{entry}

\begin{entry}{%
\irproto{map}{ proc \vari{list} \varii{list} \dotsfoo}{procedure}}

\domain{\var{proc} shall be a procedure; if any of the \varj{list}
are nonempty, then \var{proc} shall take as many arguments as there
are \varj{list}.
A natural number $n$ shall exist such
...
\domain{A natural number $n$ shall exist such
that all \varj{list} are plausible lists of length $n$.}
\end{entry}
...
\domain{\var{list} shall be a plausible list where, for every
...
\domain{\var{proc} shall be a procedure; if any \varj{l} is
    nonempty, then \var{proc} shall take as many arguments
...
\domain{\var{proc} shall be a procedure; it shall take a single argument
    if \var{list} is non-empty.
    \var{list} shall be a plausible list.}
\end{entry}
...
\domain{\var{proc} shall be a procedure;
  if \var{l} is nonempty, then it shall take a single argument.
  \var{l} shall be a plausible list or a value according to the
  conditions specified below.}

If \var{l} is not a plausible list, then it shall be such that a
...
\domain{\var{al} (for ``association list'') shall be a a plausible
  alist or a value according to the conditions specified below.
  \var{proc} shall be a procedure; if \var{al} is nonempty, then
  \var{proc} shall take a single argument.}

If \var{al} is not a plausible alist, then a natural number $n$ shall
