...
\newcommand{\deflibrary}[1]{\library{#1}\index{#1@\texttt{\library{#1} library}}}
...
% Condition-type prototype
 \newcommand{\ctproto}[1]{\index{#1@{\tt\&#1}}\pproto{\&#1}{condition type}}
...
\newcommand{\irproto}[3]{\index{#1}\rproto{#1}{#2}{#3}}
