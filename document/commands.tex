...
\newcommand{\ampindex}[1]{\reallyindex{#1}{ampfoo}{aux}}
\newcommand{\libindex}[1]{\reallyindex{#1}{libfoo}{main}}
...
% Condition-type prototype
 \newcommand{\ctproto}[1]{\ampfoo{#1}\pproto{\ampfoo{#1}}{condition type}}
