...
syntax, something that the other comment mechanisms cannot do.  {\cf
  \sharpsign\verticalbar} \ldots {\cf \verticalbar\sharpsign} as such
cannot comment out an arbitrary datum.
...
in random behavior.  This was in sharp contrast to the common assumption
that Scheme was a ``safe'' language where each
...
The description of macro expansion is considerably more involved than
