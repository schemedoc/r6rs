...
\item Macro definitions may be included in portable code.
  Hence, it should be possible to export macro bindings from libraries, with all
...
The ports returned by {\cf standard-input-port}, {\cf
  standard-output-port}, and {\cf standard-error-port} are fresh so it
...
awkward or insufficient to represent file names on some platforms,
