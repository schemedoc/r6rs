...
or to include
forms that may be required only if some future extension is
made.
...
may lead to more modular code (and less need for the prefixing and renaming
of imports), the existence of local imports would mean that a library's
dependencies are not readily apparent from a library header.
...
the decision to omit local import, this reflects the desire
to make library dependencies readily apparent from the library
header.
