...
identifiers.
The {\cf syntax-case} system~\cite{Dybvig:syntactic} described here
...
An exception with condition type {\cf\&syntax} is signaled if the keyword appears on the
...
the left-hand side of a {\cf set!} expression, however, an error
is not signaled.
