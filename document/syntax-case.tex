...
However, syntax objects representing identifiers are distinct
...
that evaluates to a transformer.  (This is only the user's
...
\domain{\var{Proc} should be a procedure that accepts one argument,
a wrapped syntax object, and returns a syntax object.}
...
definition for {\cf letrec} in report appendix~\extref{report:derivedformsappendix}{Sample definitions for derived forms}.
\end{entry}
