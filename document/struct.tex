...
result of the evaluation or not.  C, C$^\sharp$, Common Lisp, Python,
...
allows identifiers to denote denote locations containing values.
...
useful to think of the variable denoting the value directly.
