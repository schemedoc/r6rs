...
library section~\extref{simpleiosection}{Simple I/O}).  The {\cf
...
library (see library chapter~\extref{programlibchapter}{Command-line
  access and exit values}.  It then opens the file using {\cf
  open-file-input-port} (see library section~\extref{portsiosection}),
