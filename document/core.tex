...
FIXME: \hyper{body} is not merely a sequence of one or more expressions
FIXME: should probably refer Internal definititions section, possibly
FIXME: renamed appropriately, and have that section cover declarations
FIXME: as well
