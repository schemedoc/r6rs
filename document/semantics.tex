...
We assume the reader has a basic familiarity with c ontext-sensitive
...
\section{Call/cc and Dynamic Wind}\label{sec:callcc}
...
arise via a continuation throw and via programs that \sy{set!}
like this:
%
\begin{displaymath}
  \begin{array}{l}
...
\end{displaymath}
%
So, the must be covered to show what happens in those situations. The
only other departure from standard top-level library syntax is the
