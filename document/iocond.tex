...
exported by both the \library{r6rs i/o ports} and \library{r6rs
  i/o simple} libraries.  They are also exported by the \library{r6rs
  files} library described in chapter~\ref{filesystemchapter}.
