...
FIXME: this material has just been moved here from the syntax-case chapter
...
processes the initial forms in a {\cf library} or {\cf lambda} body
from left to right.
...
syntactic abstraction, {\cf define-syntax} form, {\cf define}
