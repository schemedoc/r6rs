...
\begin{entry}{%
\proto{forall}{ proc \vari{list} \varii{list} \dotsfoo}{procedure}
\proto{exists}{ proc \vari{list} \varii{list} \dotsfoo}{procedure}}
...
\domain{The \var{list}s must be lists, and \var{proc} must be a
  ...
  length.}  {\cf Forall} applies \var{proc} element-wise to the
elements of the \var{list}s.  If \var{proc} returns \schtrue{}
...
elements of the \var{list}s.  If \var{proc} returns \schfalse{}
