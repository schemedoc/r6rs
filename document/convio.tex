...
This section describes the \defrsixlibrary{i/o simple} library, which
...
returned. If \var{proc} does not return, then the port is not
...
procedures in the \rsixlibrary{i/o ports} library.
\end{entry}
...
the \rsixlibrary{i/o ports} library.
\end{entry}
...
\domain{\var{Thunk} must be a procedure that accepts zero arguments.}  The
...
This reads from \var{textual-input-port},
...
\var{textual-output-port}.  This returns \unspecifiedreturn.
