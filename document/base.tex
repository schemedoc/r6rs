...
of {\cf syntax-rules}\schindex{syntax-rules}, {\cf
...
\domain{\var{Args} must be a list.
 \var{Proc} should accept $n$ arguments, where $n$ is
  number of \var{arg}s plus the length of \var{args}.}
...
and each should accept zero arguments.
These procedures may return any number of values.}
...
such as returned by {\cf syntax-rules} or {\cf identifier-syntax}
