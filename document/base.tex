...
\hyper{body} is a body according to section~\ref{bodiessection}; its
\hyper{sequence} may be empty if the {\cf let-syntax} form occurs in a
place where a definition is allowed.  It is a
