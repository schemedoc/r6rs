...
{\cf else}\schindex{else} are exported with level $0$, and the
...
\meta{toplevel body} (section~\ref{programsyntaxsection}),
...
A variable definition has one of the following forms:\mainschindex{define}
