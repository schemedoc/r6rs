...
time, to a transformer.  (See library section~\ref{lib:transformerssection}).
...
as nodes with outgoing edges, uses {\cf
  ...
  bytes=?} to compare bytes objects (see library chapter~\ref{lib:byteschapter}),
...
library section~\ref{lib:portsiosection}) when they reach end of file.
...
Library chapter~\ref{lib:numberchapter} describes
...
see library section~\ref{lib:flonumssection})
...
library chapter~\ref{lib:exceptionsconditionschapter}) has the following condition types:
%
\begin{itemize}
...
library chapter~\ref{lib:syntaxcasechapter}).  It is a
...
library has been imported; see library chapter~\ref{lib:syntaxcasechapter}.
...
(see library chapter~\ref{lib:exceptionsconditionschapter}).
...
mechanism described in library chapter~\ref{lib:exceptionsconditionschapter}, and
