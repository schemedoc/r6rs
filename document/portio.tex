...
If \var{transcoder} is specified, it becomes
...
When the procedure is called, it returns a bytevector consisting of the
...
argument. Whenever \var{proc} returns, a bytevector consisting of the
...
When the procedure is called, it returns a string consisting of the port's
