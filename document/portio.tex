...
using the {\cf with-input-from-file} procedure from the \library{r6rs
  i/o simple} library (see section~\ref{with-input-from-file}).
\end{entry}
...
standard error, respectively.  The return value of {\cf
  ...
  with-output-to-file} procedure from the \library{r6rs i/o simple}
