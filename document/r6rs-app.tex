...
\def\headertitle{Revised$^{5.96}$ Scheme Non-Normative Appendices}
...
\begin{center}   {\huge\bf
        Revised{\Huge$^{\mathbf{\htmlonly\tiny\endhtmlonly{}5.96}}$} Report on the Algorithmic Language \\
                              \vskip 3pt
                              Scheme\\
                                \vskip 1.5ex
...
\multicolumn{4}{c}{\bf 27 June 2007}
\end{tabular}
$$
