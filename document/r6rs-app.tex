...
the report-conformant mode.  Implementors are encouraged to clearly
...
\item For {\cf identifier-syntax} forms (see report
  section~\extref{report:identifier}{Macro transformers}), the two
...
different versions to coexist in the same program are encouraged to
