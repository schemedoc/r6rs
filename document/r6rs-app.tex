...
\begin{center}   {\huge\bf
        Revised{\Huge$^{\mathbf{\htmlonly\tiny\endhtmlonly{}5.92}}$} Report on the Algorithmic Language \\
                              \vskip 3pt
                              Scheme\\
                                \vskip 1.5ex
...
appendices contain suggestions for implementors on issues not fit for
standardization, specifically platform-specific issues.

This document frequently refers back to the \textit{Revised$^6$ Report
  on the Algorithmic Language Scheme}~\cite{R6RS} and the
textit{Revised$^6$ Report on the Algorithmic Language Scheme ---
