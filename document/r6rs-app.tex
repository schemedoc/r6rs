...
\def\headertitle{Revised$^{5.95}$ Scheme Non-Normative Appendices}
...
\begin{center}   {\huge\bf
        Revised{\Huge$^{\mathbf{\htmlonly\tiny\endhtmlonly{}5.95}}$} Report on the Algorithmic Language \\
                              \vskip 3pt
                              Scheme\\
                                \vskip 1.5ex
...
\multicolumn{4}{c}{\bf 24 June 2007}
\end{tabular}
$$
...
Implementors are encouraged to clearly document the nature of the
default mode and how to enter a report-conformant mode.  Moreover,
implementations are encouraged to report when a program or library
makes use of non-recommended features where feasible and useful.  For
example, implementations that allow two libraries of the same name
with different versions to coexist in the same program are encouraged
to report when processing a program that actually makes use of this
extension.
...
places.  In particular, programmers are encouraged to restrict use of
